...
from duka.core.utils import valid_timeframe, TimeFrame, valid_symbol
...
def main():
    ...
    parser.add_argument('-t', '--thread', type=int, help='number of threads (default 20)', default=1)
    ...
    parser.add_argument('-m', '--mergin', type=int, help='sabun', default=0)
    ...
    set_up_signals()
    app(args.symbols, start, end, args.thread, args.candle, args.folder, args.header, args.mergin)
